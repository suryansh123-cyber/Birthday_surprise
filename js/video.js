/* ============================================================================
   VIDEO — cinematic custom player.
   Automatically plays when visible.
   Autoplay starts MUTED because browsers block autoplay with sound.
   ============================================================================ */
...
(function (NS) {
  ...
  function player(host, spec, opts) {
    ...
    big.innerHTML =
      '<span class="vid-play-ring" aria-hidden="true"></span>' +
    ...
    bar.innerHTML =
      '<button type="button" class="vid-btn vid-toggle" aria-label="Pause">' +

        '<svg class="i-play" viewBox="0 0 24 24" width="16" height="16" aria-hidden="true" hidden>' +
          '<path d="M8 5.5v13l11-6.5z" fill="currentColor"/>' +
        '</svg>' +
      ...
      '<div class="vid-seek" role="slider" tabindex="0" aria-label="Seek" ' +
        ...
        '<span class="vid-seek-track">' +
          '<i class="vid-seek-fill"></i>' +
        '</span>' +
      ...
      '<button type="button" class="vid-btn vid-mute" aria-label="Unmute">' +
        ...
        '<svg class="i-muted" viewBox="0 0 24 24" width="16" height="16" aria-hidden="true">' +
          ...
          '<path d="M16 9l5 6M21 9l-5 6" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" fill="none"/>' +
        '</svg>' +

        '<svg class="i-loud" viewBox="0 0 24 24" width="16" height="16" aria-hidden="true" hidden>' +
          '<path d="M4 9v6h4l5 4V5L8 9H4z" fill="currentColor"/>' +
          '<path d="M16.5 8.5a5 5 0 010 7M19 6a8.5 8.5 0 010 12" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" fill="none"/>' +
        '</svg>' +
      ...
      '<button type="button" class="vid-btn vid-full" aria-label="Fullscreen">' +
        ...
        '<svg viewBox="0 0 24 24" width="16" height="16" aria-hidden="true">' +
          '<path d="M4 9V4h5M20 15v5h-5M15 4h5v5M9 20H4v-5" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" fill="none"/>' +
        '</svg>' +
    ...
    var toggle = $(".vid-toggle", bar);
    var muteBtn = $(".vid-mute", bar);
    var fullBtn = $(".vid-full", bar);
    var seek = $(".vid-seek", bar);
    var fill = $(".vid-seek-fill", bar);
    var timeEl = $(".vid-time", bar);
    ...
    seek.addEventListener("pointermove", function (e) {
      ...
      if (seek.classList.contains("dragging")) {
        seekTo(e.clientX);
      }
    });
        ...
        function (entries) {
          ...
          entries.forEach(function (e) {
            ...
            if (e.isIntersecting) {
              ...
              /*
               * Automatically play as soon as 35%
               * of the video enters the viewport.
               */
              if (!env.reduced && !env.lowPower) {
                autoPlay();
              }
